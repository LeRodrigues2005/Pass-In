...
namespace PassIn.Api.Filters
{
    ...
    {
        public void OnException(ExceptionContext context) // sempre que houver uma exceção no código, essa função será chamada
        {
        ...
        private void ThrowUnknownError(ExceptionContext context)
        {
            ...
            context.Result = new ObjectResult(new ResponseErrorJson("Unkwnown error"));
